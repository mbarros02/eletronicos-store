...
public class ProdutoController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (action == null || action.equals("listar")) {
            ...
            req.getRequestDispatcher("/WEB-INF/views/produto/cad-produto.jsp").forward(req, resp);
            ...
            if (idStr != null) {
                ...
                req.getRequestDispatcher("/WEB-INF/views/produto/alt-produto.jsp").forward(req, resp);
            }
            ...
            if (idStr != null) {
                ...
                req.setAttribute("produto", produto);
                req.getRequestDispatcher("/WEB-INF/views/produto/visualizar-produto.jsp").forward(req, resp);
            }
        }
    }
    ...
    private void cadastrar(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            if (checarValorNulo(nome, avaliacaoStr, descricao, precoStr, estoqueStr)) {
    ...
    private void alterar(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (usuarioLogado == null) {
            resp.sendRedirect("${pageContext.request.contextPath}/usuario?action=login");
            return;
        }
    ...
    private void listarProdutos(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("filtroId", filtroId);
        req.getRequestDispatcher("/WEB-INF/views/produto/list-produto.jsp").forward(req, resp);
    }
