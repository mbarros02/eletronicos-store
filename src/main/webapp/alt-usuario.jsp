                ...
                <section id="login">
                    <div class="card">
                        ...
                        <form action="usuario" method="post">
                            ...
                            <input type="hidden" name="id" value="${usuario.id}" required readonly>
                            <div class="login">
                            ...
                            <div>
                                ...
                                <select name="idGrupo" id="" required>
                                    <option value=1 ${usuario.idGrupo==1 ? 'selected' : '' }>Administrador</option>
                                    <option value=2 ${usuario.idGrupo==2 ? 'selected' : '' }>Estoquista</option>
                                </select>
                            </div>
                            <div class="login">
